...
from braindecode.models.attention import Attention
...
class ShallowFBCSPNet(BaseModel):
    ...
    def create_network(self):
        ...
        if self.split_first_layer:
            ...
            model.add_module("attention", Attention(in_dim=1, channel_num=1))
            model.add_module(
                "conv_time",
                nn.Conv2d(
                    3,
        ...
        # )
        #
        # model.add_module("nonlin_1", Expression(self.conv_nonlin))
        #
        # model.add_module(
        #     "pool_1",
        #     pool_class(
        ...
        # )
        # model.add_module(
        #     "pool_nonlin_1", Expression(self.pool_nonlin)
        # )
